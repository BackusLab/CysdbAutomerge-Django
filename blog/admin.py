...
from .models import UploadFile, Ligandable, Hyperreactive, Identified

class IdentifiedDisplay(admin.ModelAdmin):
...
admin.site.register(Identified, IdentifiedDisplay)
