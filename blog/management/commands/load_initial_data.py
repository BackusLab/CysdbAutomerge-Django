...
from blog.models import Cysdb, UploadFile

class Command(BaseCommand):
    help = 'Load initial data from CSV file'

    def handle(self, *args, **kwargs):
        if Cysdb.objects.exists():
        ...
        with open(file_path, newline='') as csvfile:
            ...
            for row in reader:
                ...
                Cysdb.objects.create(file = file_instance, level= row['level'], proteinid = row['proteinid'], cysteineid = row['cysteineid'],
